...
int number;
inputNumbers(&number, 1, "Enter number: ", 0);//number contains recived data, 1 is lenght of buffer. "Enter number: " - is text shoowed before input, in which can be %d, %d is (index + 0) - 0 is 4th argument.
